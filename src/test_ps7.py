...
def test3p2():
    ...
    make('mpi2norm_driver.exe')
    runWithArguments("mpi2norm_driver.exe", "100")
...
def test3p3():
    ...
    make('mpi2norm_timer.exe')
    runWithArguments('mpi2norm_timer.exe', '100')
